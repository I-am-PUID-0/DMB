...
services:
  DMB:
    ...
    volumes:
      ...
      - /home/username/docker/DMB/mnt/debrid:/mnt/debrid:rshared     ## Location for rclone mount and symlinks      
    ...
    environment:
      ...
      - PGID=
      - DMB_LOG_LEVEL=INFO
      - RIVEN_FRONTEND_ENV_ORIGIN=http://127.0.0.1:3000             ## See Riven documentation for more details
...
services:
  plex:
    ...
    volumes:
      ...
      - /home/username/docker/DMB/Zurg/mnt/debrid:/mnt/debrid ## Add the symlink location/s to plex library
    environment:
      - TZ=
...
| `/mnt/debrid`         | rshared     | This is where rclone and symlinks will be mounted.                                                                                                                                                                                                       |
